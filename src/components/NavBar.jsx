...
function NavBar() {
  ...
  return (
    <div className="fixed bottom-0 w-full h-24 bg-black/60 flex justify-around z-50 items-center pb-4">
      <div
        className="h-14 w-14 bg-black rounded-full border-2 border-white flex justify-center items-center"
      ...
      <div
        className="h-14 w-14 bg-black rounded-full border-2 border-white flex justify-center items-center"
        onClick={() => navigate("/editar-alumno")}
      >
      ...
      <div
        ...
        onClick={() => navigate("/")}
      >
        <BsUiChecks color="white" size={25} />
      </div>
      <div
        className="h-14 w-14 bg-black rounded-full border-2 border-white flex justify-center items-center"
        onClick={() => navigate("/ranking")}
      >
        <FaRankingStar color="white" size={25} />
      </div>
    </div>
  );
}
